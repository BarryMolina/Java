...
public class TextMenu extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        outputLable = new Label("Hello World");
        ...
        borderPane.setCenter(outputLable);
    ...
    private void buildTextMenu() {
        ...
        blackItem.setOnAction(event -> {
            outputLable.setStyle("-fx-text-fill: black");
        });
        redItem.setOnAction(event -> {
            outputLable.setStyle("-fx-text-fill: red");
        });
        greenItem.setOnAction(event -> {
            outputLable.setStyle("-fx-text-fill: green");
        });
        blueItem.setOnAction(event -> {
            outputLable.setStyle("-fx-text-fill: blue");
        });
        visibleItem.setOnAction(event -> {
            if (outputLable.isVisible())
                outputLable.setVisible(false);
            else 
                outputLable.setVisible(true);
        });
